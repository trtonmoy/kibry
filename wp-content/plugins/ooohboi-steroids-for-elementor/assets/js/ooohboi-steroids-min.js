...
!(function (e, t) {
  ...
  s.on("elementor/frontend/init", function () {
    var t = elementorModules.frontend.handlers.Base.extend({
        ...
        onElementChange: function (e) {
          "_ob_bbad_use_it" === e &&
            ("yes" === this.getElementSettings("_ob_bbad_use_it")
              ? (this.$element.addClass("ob-is-breaking-bad"),
                this.isInnerSection() && this.$element.addClass("ob-bb-inner"))
              : (this.$element.removeClass("ob-is-breaking-bad"),
                this.isInnerSection() &&
                  this.$element.removeClass("ob-bb-inner"))),
            "_ob_glider_is_slider" === e &&
              ("yes" === this.getElementSettings("_ob_glider_is_slider")
                ? (this.$element.addClass("ob-is-glider"),
                  this.addClassesRouteGlider(
                    ".elementor-element-" + this.$element.attr("data-id"),
                    "addClass"
                  ),
            ...
            "_ob_bbad_sssic_use" === e &&
              this.isInnerSection() &&
              ("yes" === this.getElementSettings("_ob_bbad_sssic_use")
        ...
        addClassesRouteGlider: function (t, s) {
          ...
          o.length && "addClass" == s
            ? (o.addClass("swiper-wrapper"),
              e(o).children("div.elementor-column").addClass("swiper-slide"))
            : o.length ||
              "addClass" != s ||
              (e(i)
                .children("div.elementor-column")
            ...
            o.length && "removeClass" == s
              ? (i.removeClass("swiper-container"),
                o.removeClass("swiper-wrapper"),
                e(o)
                  .children("div.elementor-column")
              ...
              : o.length ||
                "removeClass" != s ||
                (i.removeClass("swiper-container"),
                e(i).children("div.swiper-wrapper").unwrap(),
                e(i)
                  .children("div.elementor-column")
                  .removeClass("swiper-slide"));
        },
        ...
        initSwiperElements: function () {
          ...
          var e = {};
          (e.pagination_type = this.getElementSettings(
            "_ob_glider_pagination_type"
          )),
            (e.allowTouchMove = this.getElementSettings(
              "_ob_glider_allow_touch_move"
            )),
            (e.autoheight = this.getElementSettings("_ob_glider_auto_h")),
            (e.effect = this.getElementSettings("_ob_glider_effect")),
            (e.loop = this.getElementSettings("_ob_glider_loop")),
            (e.direction = this.getElementSettings("_ob_glider_direction")),
            (e.parallax = this.getElementSettings("_ob_glider_parallax")),
            (e.speed = this.getElementSettings("_ob_glider_speed"));
          var t = this.getElementSettings("_ob_glider_autoplay");
          (e.autoplay = !!t && {
            delay: this.getElementSettings("_ob_glider_autoplay_delay"),
          }),
            (e.mousewheel = this.getElementSettings(
              "_ob_glider_allow_mousewheel"
            )),
            (e.allowMultiSlides = this.getElementSettings(
              "_ob_glider_allow_multi_slides"
            ));
          var s = {},
            o = elementorFrontend.config.breakpoints;
          (s[o.lg] = {
            slidesPerView: this.getElementSettings(
              "_ob_glider_slides_per_view"
            ),
            slidesPerGroup: this.getElementSettings(
              "_ob_glider_slides_to_scroll"
            ),
            spaceBetween:
              +this.getElementSettings("_ob_glider_space_between") || 0,
          }),
            (s[o.md] = {
              slidesPerView: this.getElementSettings(
                "_ob_glider_slides_per_view_tablet"
              ),
              slidesPerGroup: this.getElementSettings(
                "_ob_glider_slides_to_scroll_tablet"
              ),
              spaceBetween:
                +this.getElementSettings("_ob_glider_space_between_tablet") ||
                0,
            }),
            (s[0] = {
              slidesPerView: this.getElementSettings(
                "_ob_glider_slides_per_view_mobile"
              ),
              slidesPerGroup: this.getElementSettings(
                "_ob_glider_slides_to_scroll_mobile"
              ),
              spaceBetween:
                +this.getElementSettings("_ob_glider_space_between_mobile") ||
                0,
            }),
            (e.breakpoints = s),
            (e.slides_centered = this.getElementSettings(
              "_ob_glider_centered_slides"
            )),
            (e.slides_centered_bounds = this.getElementSettings(
              "_ob_glider_centered_bounds_slides"
            )),
            (e.slides_round_lenghts = this.getElementSettings(
              "_ob_glider_roundlengths_slides"
            )),
            i(
              this.$element.attr("data-id"),
              e,
              "glider_" + this.$element.attr("data-id")
            );
        },
      }),
      o = elementorModules.frontend.handlers.Base.extend({
        onInit: function () {
          elementorModules.frontend.handlers.Base.prototype.onInit.apply(
            ...
            this.$element.find(".elementor-column-wrap").first().length ||
              this.$element.addClass("ob-is-e3");
          var e = navigator.userAgent.toLowerCase();
          e.indexOf("chrome") > -1 && this.teleporterChromeResize(),
        ...
        teleporterChromeResize: function () {
          if (this.isTeleporter()) {
            ...
            s.on("resize", function () {
              e.$element
                .closest(".ob-is-teleporter")
                .addClass("ob-chrome-resize"),
                clearTimeout(t),
                (t = setTimeout(function () {
                  var t = parseInt(
                      e.$element.closest(".ob-is-teleporter").css("height")
                    ),
        ...
        initColumnExtends: function () {
          if (!this.isEdit) {
            ...
            if (void 0 !== e._ob_bbad_link) {
              ...
              if ("" === t.url)
                return void this.$element.removeClass("bb-column-link");
          ...
          this.isEdit &&
            "use-teleporter" ===
              this.getElementSettings("_ob_teleporter_use") &&
            (this.$element.addClass("ob-is-teleporter"),
            this.$element
              .find(".elementor-widget-wrap")
              .first()
              .addClass("ob-tele-midget"),
            ...
            !this.isEdit &&
              ...
              this.doTeleporter()),
            this.isEdit &&
              "yes" === this.getElementSettings("_ob_bbad_is_stalker") &&
              this.$element.addClass("ob-is-stalker");
        },
        onElementChange: function (e) {
          "_ob_teleporter_overlay_color" === e
            ? this.$element
                .find('div[class*="ob-teleporter-"] > .ob-tele-overlay')
                .css(
                  "background-color",
                  this.getElementSettings("_ob_teleporter_overlay_color")
                )
            : "_ob_teleporter_no_pass_tablet" === e
            ? "no-tablet" ===
              this.getElementSettings("_ob_teleporter_no_pass_tablet")
              ? this.$element.addClass("ob-tele-no-tablet")
              : this.$element.removeClass("ob-tele-no-tablet")
            : "_ob_teleporter_no_pass_mobile" === e &&
              ("no-mobile" ===
              this.getElementSettings("_ob_teleporter_no_pass_mobile")
        ...
        doTeleporterEditor: function () {
          if (
            "use-teleporter" === this.getElementSettings("_ob_teleporter_use")
          ) {
            var t = this.$element.find(".elementor-widget-wrap").first();
            if (
              (t.length &&
                (t.wrapInner('<div class="widget-wrap-children" />'),
                t.find(".elementor-background-overlay").first().length &&
                  t
                    .find(".elementor-background-overlay")
                    .first()
                    .insertBefore(
                      t.find(".elementor-background-overlay").first().parent()
                    )),
              "do-pass" === this.getElementSettings("_ob_teleporter_pass"))
            ) {
              var s = this,
                i = this.$element,
              ...
              var n =
                "section" ===
                this.getElementSettings("_ob_teleporter_pass_element")
                  ? this.$element.closest(".elementor-section")
                  : this.$element.closest(".elementor-container");
              if (n.length) {
                ...
                var l = this.getElementSettings("_ob_teleporter_pass_effect"),
                  r =
                    ...
                    '" data-id-teleporter="' +
                    o +
                    '"><div class="ob-tele-overlay" style="background-color: ' +
                    this.getElementSettings("_ob_teleporter_overlay_color") +
                    ';"></div></div>';
                e(".ob-teleporter-" + o).length || this.$element.prepend(r),
                  this.$element.off("mouseenter mouseleave"),
                  this.$element.on("mouseenter mouseleave", function (t) {
                    if ("mouseenter" === t.type) {
                      ...
                      if (
                        "do-pass" !==
                        s.getElementSettings("_ob_teleporter_pass")
                      )
                        return;
                      var l = {
                        "background-color": e(".ob-teleporter-" + o).css(
                          "background-color"
                        ),
                        "background-image": e(".ob-teleporter-" + o).css(
                          "background-image"
                        ),
                        "background-position": e(".ob-teleporter-" + o).css(
                          "background-position"
                        ),
                        "background-size": e(".ob-teleporter-" + o).css(
                          "background-size"
                        ),
                        "background-repeat": e(".ob-teleporter-" + o).css(
                          "background-repeat"
                        ),
                      };
                      if (
                        "section" ===
                        s.getElementSettings("_ob_teleporter_pass_element")
                      ) {
                        var r = n
                          .children()
                          ...
                          .detach();
                        n
                          .addClass("ob-tele-mom-hover")
                          .prepend(e(".ob-teleporter-" + o)),
                          n.prepend(r);
                      } else
                        n.addClass("ob-tele-mom-hover").prepend(
                          e(".ob-teleporter-" + o)
                        );
                      e(".ob-teleporter-" + o)
                        .css(l)
                        .hide(),
                        e(".ob-teleporter-" + o)
                          .addClass("ob-teleporter-hover")
                          .show();
                    } else
                      n.removeClass("ob-tele-mom-hover"),
                        setTimeout(function () {
                          e(".ob-teleporter-" + o)
                            .removeAttr("style")
                            .removeClass("ob-teleporter-hover"),
                            i.prepend(e(".ob-teleporter-" + o));
                        }, 100);
                  });
              }
            }
        ...
        doTeleporter: function () {
          ...
          if ("use-teleporter" === t._ob_teleporter_use) {
            ...
            s.length &&
              (s.wrapInner('<div class="widget-wrap-children" />'),
              s.find(".elementor-background-overlay").first().length &&
                s
                  .find(".elementor-background-overlay")
                  .first()
                  .insertBefore(
                    s.find(".elementor-background-overlay").first().parent()
                  ));
            var i = this.$element,
              o = this.$element.attr("data-id");
            if (
              ("no-tablet" === t._ob_teleporter_no_pass_tablet &&
                this.$element.addClass("ob-tele-no-tablet"),
              "no-mobile" === t._ob_teleporter_no_pass_mobile &&
                this.$element.addClass("ob-tele-no-mobile"),
              void 0 !== t._ob_teleporter_link)
            ) {
            ...
            if ("do-pass" === t._ob_teleporter_pass) {
              var l =
                "section" === t._ob_teleporter_pass_element
                  ? this.$element.closest(".elementor-section")
                  : this.$element.closest(".elementor-container");
              if (l.length) {
                ...
                var r = t._ob_teleporter_pass_effect,
                  a =
                    ...
                    o +
                    '"><div class="ob-tele-overlay" style="background-color: ' +
                    t._ob_teleporter_overlay_color +
                    ';"></div>';
                e(".ob-teleporter-" + o).length || this.$element.prepend(a),
                  this.$element.off("mouseenter mouseleave"),
                  this.$element.on("mouseenter", function () {
                    if (
                      ...
                      if ("section" === t._ob_teleporter_pass_element) {
                        ...
                        l.addClass("ob-tele-mom-hover").prepend(
                          e(".ob-teleporter-" + o)
                        );
                      e(".ob-teleporter-" + o)
                        .css(s)
                  ...
                  this.$element.on("mouseleave", function () {
                    l.removeClass("ob-tele-mom-hover"),
                      setTimeout(function () {
                        e(".ob-teleporter-" + o)
                          .removeAttr("style")
                          .removeClass("ob-teleporter-hover"),
  ...
  var i = function (t, s) {
    ...
    n.find('[class*="glider-control"]').on("click", function (t) {
      if (void 0 !== e(this).data("gotoslide"))
        i.slideTo(parseInt(e(this).data("gotoslide")));
      else {
        var s = parseInt(
          e(this)
            .attr("class")
            .match(/glider-control-(\d+)/)[1]
        );
        s > 0 && i.slideTo(s);
      }
      t.preventDefault();
