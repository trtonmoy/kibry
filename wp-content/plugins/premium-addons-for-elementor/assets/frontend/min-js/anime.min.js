      ...
      return (
        ...
        w.rgb(s)
          ...
          ? ((i = s.replace(
            ...
            (u = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(i)),
            "rgba(" +
              parseInt(u[1], 16) +
              "," +
              parseInt(u[2], 16) +
          ...
          : w.hsl(s)
          ? ((i =
              /hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/g.exec((i = s)) ||
              /hsla\((\d+),\s*([\d.]+)%,\s*([\d.]+)%,\s*([\d.]+)\)/g.exec(i)),
            (u = parseInt(i[1], 10) / 360),
            ...
            0 == s
              ? (r = a = o = c)
              : ((r = t(
                  (s = 2 * c - (c = c < 0.5 ? c * (1 + s) : c + s - c * s)),
                  c,
                  u + 1 / 3
                )),
                (a = t(s, c, u)),
                (o = t(s, c, u - 1 / 3))),
            "rgba(" + 255 * r + "," + 255 * a + "," + 255 * o + "," + i + ")")
          : void 0
      );
    function t(n, e, t) {
      return (
  ...
  function L(n) {
    ...
    function y(e) {
      for (var n = 0, t = k.animations, r = t.length; n < r; ) {
        ...
        _[a.type](o.target, a.property, h, o.transforms),
          (a.currentValue = h),
          n++;
      }
    }
    ...
    return (
      ...
      (k.play = function () {
        k.paused &&
          (k.completed && k.reset(), (k.paused = !1), S.push(k), o(), nn());
      }),
      (k.reverse = function () {
